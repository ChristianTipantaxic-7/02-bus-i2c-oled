...
void setup() {
    ...
    // CHECK 2.1: Arrancar la pantalla activando la bomba de carga interna (charge pump)
    ...
    // CHECK 2.2: Construir la cabecera visual en el buffer RAM:
